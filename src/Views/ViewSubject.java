...
public class ViewSubject extends javax.swing.JInternalFrame {
    ...
    public ViewSubject() {
        ...
        subjectController.loadSubjectTable(subjectTable);
    ...
    private void initComponents() {
        ...
        titleLabel.setText("     View Subject Details");
        ...
        subjectScrollPane.setBackground(new java.awt.Color(255, 255, 255));
        ...
        subjectTable.setGridColor(new java.awt.Color(0, 0, 153));
        ...
        contentPanel.add(subjectScrollPane);
        subjectScrollPane.setBounds(110, 70, 1130, 430);
    ...
    private void yesButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_yesButtonActionPerformed
        ...
        String message[] = subjectController.deleteSubject(subjectCode);
        setAlertDialog(message);
    ...
    private void subjectTableMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_subjectTableMouseClicked
        ...
        subjectCode = subjectTable.getValueAt(r, 1).toString();
